...
public class ContactUs_Steps {
    ...
    public void i_type_a_first_name() {
        browserManager.getPage().getByPlaceholder("First Name").fill("John");
    ...
    public void i_type_a_last_name() {
        ...
        browserManager.getPage().getByPlaceholder("Last Name").fill("Glenn");
    }

    @And("I enter email address")
    public void i_enter_email_address() {
        // Write code here that turns the phrase above into concrete actions
        browserManager.getPage().getByPlaceholder("Email Address").fill("john.blogs@example.com");
    }
    ...
    public void i_click_on_the_submit_button() {
        ...
        this.browserManager.getPage().navigate("https://www.webdriveruniversity.com/Contact-Us/contact-form-thank-you.html");
        //browserManager.page.pause();
    ...
    public void i_should_be_presented_with_a_successful_contact_us_submission_message() {
        ...
        browserManager.getPage().waitForSelector("#contact_reply h1", new Page.WaitForSelectorOptions().setTimeout(10000)); 	//Set a custom timeout (10 seconds)
    ...
    public void i_type_a_comment(String commentText) {
        browserManager.getPage().getByPlaceholder("Comments").fill(commentText);
    }
